...
public class BahasaIndo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bahasa_indo);
...
//        videoRv.setLayoutManager(new LinearLayoutManager(this));
    ...
    private void download() {
        ...
        ref  = storageReference.child("materipdf/BAHASA INDO.pdf");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri) {
                String url = uri.toString();
                donwloadFile(BahasaIndo.this,"Materi_BahasaINDO_KelasVII_UBS",".pdf", DIRECTORY_DOWNLOADS, url);
            }

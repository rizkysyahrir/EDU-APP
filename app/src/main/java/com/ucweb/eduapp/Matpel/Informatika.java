...
//        videoRv.setLayoutManager(new LinearLayoutManager(this));
    ...
    private void download() {
        ...
        ref  = storageReference.child("materipdf/INFORMATIKA-BS-KLS_VII.pdf");
        ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
            @Override
            public void onSuccess(Uri uri) {
                String url = uri.toString();
                donwloadFile(Informatika.this,"Materi_Informatika_KelasVII_UBS",".pdf", DIRECTORY_DOWNLOADS, url);
            }

...
import com.ucweb.eduapp.SpinWheel.LuckyWheelView;
import com.ucweb.eduapp.SpinWheel.model.LuckyItem;
import com.ucweb.eduapp.databinding.ActivitySpinBinding;
    ...
    void updateCash(int index){
        ...
        db.collection("users")
            ...
            public void onSuccess(Void aVoid) {
                Toast.makeText(SpinActivity.this, "Koin ditambahkan ke akun anda.", Toast.LENGTH_SHORT).show();
                finish();
            }
        });
    }
